...
public class Sorting {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("время сортировки ~ " + timeForBubbleSort);
        double timeForSelectionSort = timeForSelectionSort(5);
        System.out.println("время сортировки ~ " + timeForSelectionSort);
        double timeForInsertionSort = timeForInsertionSort(5);
        System.out.println("время сортировки ~ " + timeForInsertionSort);
    }
    ...
    private static void sortSelection(int[] arr) {
        for (int i = 1; i < arr.length; i++) {
            ...
            swapElement(arr, i, minElementIndex);
        }
    }
